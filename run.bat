...
REM *** Windows Classic system skin ***
REM start javaw -Dswing.defaultlaf=com.sun.java.swing.plaf.windows.WindowsClassicLookAndFeel -Xms64M -Xmx512M -jar MafScaling.jar


REM *** Java Default ***
REM start javaw -Dswing.defaultlaf=javax.swing.plaf.metal.MetalLookAndFeel -Xms64M -Xmx512M -jar MafScaling.jar


REM *** Nimbus - New Java Swing . REQUIRES JAVA 7 OR GREATER ***
REM start javaw -Dswing.defaultlaf=javax.swing.plaf.nimbus.NimbusLookAndFeel -Xms64M -Xmx512M -jar MafScaling.jar
